...
- **Ссылка на свой пост** — зелёная (акцент-2); карточка с названием и описанием:
  `<a href="/blog/slug" data-link-type="internal" data-title="Заголовок" data-desc="Краткое описание">текст</a>`
- **Ссылка-цитата** — акцент + линия (если ведёт на свой пост — зелёная, без линии); карточка с выдержкой из источника:
  `<a href="/blog/slug" data-link-type="quote" data-quote="Текст цитаты" data-source="Источник">текст</a>`
- **Сноска** — зелёный номер, выносится на правое поле (на узких экранах — список внизу). Символ внутри любой, заменится номером:
